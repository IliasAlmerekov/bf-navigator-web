...
4. **Color contrast**: Flag any new or modified color combinations that may fail [WCAG 2.1](https://www.w3.org/TR/WCAG21/) AA ratios.
...
- Read and follow `CONVENTION.md` before verification.
- Run only project-relevant commands through `rtk`.
- Prefer the smallest useful automated checks first.
- For React features, verify routing, loading, error, empty, offline, retry, and accessibility states when relevant.
- Do not edit source code unless the lead agent explicitly changes your scope.
